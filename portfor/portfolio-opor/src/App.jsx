                ...
                <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
                  ...
                  >
                    ...
                    <li className="mr-5 text-xs">
                      <a
                        className="block hover:text-slate-200"
                        href="https://www.linkedin.com/in/peeraya-forwork/"
                        target="_blank"
                        rel="noreferrer"
                      >
                  ...
                  >
                    ...
                    <div>
                      <p className="mb-4">
                        ...
                        to today, and I’ve had the privilege of building
                        software for an
                        <a
                      ...
                      <p className="mb-4">
                        ...
                        leading projects for our clients at
                        <a
                          className="font-medium text-slate-200 hover:text-teal-300 focus-visible:text-teal-300"
                          ...
                          <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                            ...
                            <div className="z-10 sm:col-span-6">
                              ...
                              <p className="mt-2 text-sm leading-normal">
                                ...
                                major features of Starry’s customer-facing
                                Android app.
                              </p>
                              <ul
                                className="mt-2 flex flex-wrap"
                        ...
                        <li className="mb-12">
                          <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                            ...
                            <div className="z-10 sm:col-span-6">
                              ...
                              <p className="mt-2 text-sm leading-normal">
                                Developed, maintained, and shipped production
                                code for client websites. Clients included
                                JetBlue, Lovesac, U.S. Cellular, U.S. Department
                                of Defense, and more.
                              </p>
                              <ul
                                className="mt-2 flex flex-wrap"
                        ...
                        <li className="mb-12">
                          <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                            ...
                            <img
                              ...
                              src="https://media.licdn.com/dms/image/D5603AQFzZ0mvkZzGgg/profile-displayphoto-shrink_200_200/0/1695200667306?e=1701907200&v=beta&t=jQejwO_Qeh_zKIE-ihm2xsS6EyU0B0qZiqokdLcXDQg"
                            />
                          </div>
                        </li>
                        ...
                        <li className="mb-12">
                          <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                            ...
                            <div className="z-10 sm:order-2 sm:col-span-6">
                              ...
                              <p className="mt-2 text-sm leading-normal">
                                Web app for visualizing personalized Spotify
                                data. View your top artists, top tracks,
                                recently played tracks, and detailed audio
                                information about each track. Create and save
                                new playlists of recommended tracks based on
                        ...
                        <li className="mb-12">
                          <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                            ...
                            <div className="z-10 sm:order-2 sm:col-span-6">
                              ...
                              <p className="mt-2 text-sm leading-normal">
                                Minimal dark blue theme for VS Code, Sublime
                                Text, Atom, iTerm, and more.
                              </p>
                              <a
                                className="relative mt-2 inline-flex items-center text-sm font-medium text-slate-300 hover:text-teal-300 focus-visible:text-teal-300"
